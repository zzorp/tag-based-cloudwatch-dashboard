...
export class CloudfrontWidgetSet extends Construct implements WidgetSet {
  ...
  constructor(scope: Construct, id: string, resource: any, config: any) {
    ...
    const markDown = `### Distribution [${distId}](https://us-east-1.console.aws.amazon.com/cloudfront/v3/home?region=eu-west-1#/distributions/${distId}) ${domainName} Aliases: ${aliases} Origins: ${origins}`;
    this.widgetSet.push(
      new TextWidget({
        markdown: markDown,
        width: 24,
