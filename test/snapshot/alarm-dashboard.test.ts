...
describe('AlarmDashboardStack Snapshot', () => {
  ...
  it('should create a CloudWatch Dashboard', () => {
    const app = new App();
    const stack = new AlarmDashboardStack(app, 'TestAlarmDashboardStack2');
    const template = Template.fromStack(stack);
  ...
  it('should create Lambda functions', () => {
    const app = new App();
    const stack = new AlarmDashboardStack(app, 'TestAlarmDashboardStack3');
    const template = Template.fromStack(stack);
  ...
  it('should create a DynamoDB table', () => {
    const app = new App();
    const stack = new AlarmDashboardStack(app, 'TestAlarmDashboardStack4');
    const template = Template.fromStack(stack);
  ...
  it('should create an EventBus', () => {
    const app = new App();
    const stack = new AlarmDashboardStack(app, 'TestAlarmDashboardStack5');
    const template = Template.fromStack(stack);
