...
describe('MetricDashboardStack Snapshot', () => {
  it('should match the snapshot', () => {
    const app = new App();
    const stack = new IemDashboardStack(app, 'TestMetricDashboardStack', { config: testConfig as any });
  ...
  it('should create CloudWatch dashboards', () => {
    const app = new App();
    const stack = new IemDashboardStack(app, 'TestMetricDashboardStack2', { config: testConfig as any });
    const template = Template.fromStack(stack);
  ...
  it('should create CloudWatch alarms', () => {
    const app = new App();
    const stack = new IemDashboardStack(app, 'TestMetricDashboardStack3', { config: testConfig as any });
    const template = Template.fromStack(stack);
